...
public class CNS_SongController : MonoBehaviour
{
   ...
   // public GameObject textDisplay;
    ...
    public void SavePrefab()
    {
        ...
        string highScoreName= "HighScore"+songName.ToString();
        PlayerPrefs.SetInt(highScoreName,0);
        UnityEditor.PrefabUtility.SaveAsPrefabAsset((GameObject)gameObject, "Assets/Resources/Songs/"+ songName+".prefab");
